      ...
      cart.cartItems.length === 0 ? (
        <div className='cart-empty'>
                ...
                <div className='cart-item' key={cartItem.id}>
                  <div className='cart-product'>
                    <div className='product-name-image'>
                      <img className='' src={cartItem.image} alt={cartItem.image}/>
                      <div>
                        <h3 >{cartItem.name}</h3>
                        <button className='removeButton' onClick={()=>removeCartItemHandler(cartItem)} >Remove</button>
                      </div>
                    </div>
          ...
          <div className="cart-summary">
            <button onClick={()=>clearCarthandle()} className="clear-cart">Clear Cart</button>
