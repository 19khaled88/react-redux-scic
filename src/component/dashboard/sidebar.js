  ...
  return (
    <div className={sidebarOpen ? 'sidebar-responsive' : ""} id="sidebar">
      <div className='sidebar-title'>
        ...
        <i className='fa fa-times' id='sidebarIcon' onClick={()=>closeSideOpen()}>
        </i>
      </div>
      <div className='sidebar_menu'>
        ...
        <div className='sidebar_link'>
          ...
          {
            auth && auth.isAdmin === true ? <Link to="admin">Admin</Link> : <Link className='noAdminTitle' to="#">Admin</Link>
          }
        </div>
        <div className='sidebar_link'>
        ...
        <div className='sidebar_link'>
            ...
            {
              auth && auth.isAdmin === true ? <Link to="#">Distribution Management</Link> : <Link className='noAdminTitle' to="#">Distribution Management</Link>
            }
        </div>
        <div className='sidebar_link'>
            ...
            {
              auth && auth.isAdmin === true ? <Link to="#">Warehouse Management</Link> : <Link className='noAdminTitle' to="#">Warehouse Management</Link>
            }
        </div>
